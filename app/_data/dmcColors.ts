export type DmcColor = { floss: string; name: string; hex: string };

// Source: https://www.cassandramdias.com/dmc-colors-to-rgb-conversion-chart
const DMC_COLOR_ROWS = [
  ...
  ["561", "Celadon Green Very Dark", "#2c6a45"],
  ...
  ["890", "Pistachio Green Ultra Very Dark", "#174923"],
  ...
  ["01", "White Tin", "#e3e3e6"],
  ["02", "Tin", "#d7d7d8"],
  ["03", "Tin Medium", "#b8b8bb"],
  ["04", "Tin Dark", "#aeaeb1"],
  ["05", "Driftwood Light", "#e3ccbe"],
  ["06", "Driftwood Medium Light", "#dcc6b8"],
  ["07", "Driftwood", "#8f7b6e"],
  ["08", "Driftwood Dark", "#6a5046"],
  ["09", "Cocoa Very Dark", "#552014"],
...
export const DMC_COLORS: DmcColor[] = DMC_COLOR_ROWS.map(([floss, name, hex]) => ({
  floss,
  name,
  hex,
}));
